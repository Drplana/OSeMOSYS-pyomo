...
###########################################################################################################################
    ...
    input_files = [
        ...
        os.path.join(root_folder, 'data/03-BaseScenarioVOLL-WIND-BIO-LIMITED.xlsx'), # 1GW per year and 0.5 GW biomass



    ]
    # Ejecutar los archivos en paralelo de 3 en 3. Batch_size define el número de instancias a correr.
    scenario_manager.run_files_in_batches(input_files=input_files, batch_size=3, solver_name="appsi_highs")
