...
from OSeMOSYS.config import INPUT_FILE_PATH, RESULTS_FOLDER,COLOR_DICT
...
try:
    ...
    SELECTED_YEARS = [2020, 2024, 2025,  2040, 2050]
    om.plot_accumulated_capacity(RESULTS_FOLDER, SELECTED_YEARS)
